...
echo.
echo.
echo                HST WINDOWS OPTIMIZER v1.0
echo ============================================================
echo.
echo  [0] EXIT
echo.
...
echo [6/7] ADDING & ACTIVATING CUSTOM POWER PLAN
...
:: ############################################################
:: OPTIMIZE REGISTRY - PART 1 (500+ TWEAKS)
:: ############################################################

:OPTIMIZE_REGISTRY
cls
echo ============================================================
echo              OPTIMIZING REGISTRY (500+ TWEAKS)
echo ============================================================
echo.
call :OPTIMIZE_REGISTRY_SILENT
echo.
...
echo   - GAME MODE AND DVR (12 SETTINGS)
...
echo   - NETWORK AND LATENCY (4 SETTINGS)
...
echo   - GAMING TASK PRIORITY (7 SETTINGS)
...
echo   - KEYBOARD AND MOUSE (8 SETTINGS)
...
echo   - CONTENT DELIVERY MANAGER (24 SETTINGS)
...
echo   - WINDOWS SPOTLIGHT (10 SETTINGS)
...
echo   - SEARCH SETTINGS (6 SETTINGS)
...
echo   - CAPABILITY ACCESS MANAGER (23 PERMISSIONS)
...
echo   - BROWSER OPTIMIZATION (EDGE)
...
echo   - BROWSER OPTIMIZATION (CHROME)
...
:: ############################################################
:: OPTIMIZE TASK SCHEDULER (60+ TASKS)
:: ############################################################

:OPTIMIZE_TASKSCHEDULER
cls
echo ============================================================
echo          OPTIMIZING TASK SCHEDULER (60+ TASKS)
echo ============================================================
echo.
call :OPTIMIZE_TASKSCHEDULER_SILENT
echo.
...
exit /b
:: ############################################################
:: OPTIMIZE SERVICES MENU (100+ SERVICES)
:: ############################################################

:OPTIMIZE_SERVICES_MENU
cls
echo ============================================================
echo               OPTIMIZE SERVICES (100+)
echo ============================================================
echo.
...
echo    - IMPORTING & ACTIVATING POWER PLAN...
...
:: ############################################################
:: DEBLOAT - REMOVE MICROSOFT APPS (48 APPS)
:: ############################################################

:REMOVE_MS_APPS
cls
echo ============================================================
echo           REMOVING MICROSOFT APPS (48 APPS)
echo ============================================================
echo.
echo THIS WILL REMOVE ALL MICROSOFT BLOATWARE
pause
...
:: ############################################################
:: REMOVE XBOX APPS (8 APPS)
:: ############################################################

:REMOVE_XBOX_APPS
cls
echo ============================================================
echo               REMOVING XBOX APPS (8 APPS)
echo ============================================================
echo.
...
echo ============================================================
echo.
set /p confirm="BACKUP ONEDRIVE FILES FIRST! CONTINUE? (Y/N): "
if /i not "%confirm%"=="Y" goto MAIN_MENU
